...
## System apps
dnf -y install flatpak-builder lxpolkit seahorse just btrfs-assistant network-manager-applet blueman # libvirt virt-manager qemu-kvm wlr-randr iotop sysstat lxqt-openssh-askpass parallel  
